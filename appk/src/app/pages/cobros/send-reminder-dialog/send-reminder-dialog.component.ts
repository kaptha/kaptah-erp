      ...
      <form [formGroup]="emailForm">
        ...
        <div class="email-preview" style="margin-top: 16px; padding: 12px; background: #f5f5f5; border-radius: 4px;">
          ...
          <p style="margin: 0; font-size: 14px; color: #666;">
            ...
            <strong>Monto Pendiente:</strong> {{data.dueAmount | currency}}<br>
            <strong>Fecha de Vencimiento:</strong> {{data.dueDate | date:'dd/MM/yyyy'}}
          </p>
        </div>
      </form>
    </mat-dialog-content>
...
export class SendReminderDialogComponent {
  ...
  constructor(
    ...
    this.emailForm = this.fb.group({
      ...
      customMessage: ['Estimado cliente, le recordamos que tiene un pago pendiente. Por favor, regularice su situación a la brevedad.']
    });
  }
