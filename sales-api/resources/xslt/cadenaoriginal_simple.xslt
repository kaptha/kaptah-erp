<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cfdi="http://www.sat.gob.mx/cfd/4" xmlns:tfd="http://www.sat.gob.mx/TimbreFiscalDigital" xmlns:nomina12="http://www.sat.gob.mx/nomina12" xmlns:pago20="http://www.sat.gob.mx/Pagos20" version="1.0">
...
<xsl:call-template name="Requerido">
<xsl:with-param name="valor" select="./@Ano"/>
</xsl:call-template>
<xsl:call-template name="Requerido">
...
<xsl:param name="valor"/>
<xsl:if test="string-length(normalize-space($valor))">
|
<xsl:value-of select="normalize-space($valor)"/>
</xsl:if>
</xsl:template>
